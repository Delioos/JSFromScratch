...
//ex 1
//1
//let [e, pi, g, h, k] = constants
//console.log(e, pi, g, h, k)
...
//ex 2
//1  names scores skills age
//2 console.log(users.find(user => user.skills.length < 2))
/*
for(const {name,scores,skills,age} of users) {
    console.log(name,scores,skills,age)
    skills.length < 2 ? console.log(`${name} have ${skills.length} skills`) : skills
}
*/
...
//3 write a function called convertArrayToObject which convert the array to a structure object
const convertArrayToObject = (array) => {
  let objectsStudent = []
  for(let i = 0; i < array.length; i++){
    let [name, skills, jsScore, reactScore] = array[i]
    const student = {
      name: name,
      skills:skills,
      jsScore:jsScore,
    ...
    objectsStudent.push(student)}
  return objectsStudent
}
